    ...
    return (
        <>
            <div className='cursor'>
                ...
                <div className='circle absolute top-[50%] left-[50%] pointer-events-none translate-x-[-50%] translate-y-[-50%] z-[1000] transition-all duration-[60ms] ease-linear border-solid border-sky-500 border-2 p-[30px] rounded-full'></div>
            </div>
        </>
    )
}