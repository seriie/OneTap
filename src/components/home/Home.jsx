            ...
            <div className="content-app items-center flex justify-between">
                <div className='left w-[500px]'>
                    ...
                    <a href='#product' className='focus:outline-none'>
                        <button className='content-button triggered-hover focus:outline-none mt-[20px] font-semibold py-[15px] px-[20px] text-2xl border-solid border-2 rounded-[8px] border-slate-900'>
                            Get Started
                        </button>
                    </a>
                </div>
